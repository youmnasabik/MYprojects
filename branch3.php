...
<html>
        ...
        <form action="branch3.php" method="POST">
                    <div class="col">
                        <br />
...
for ($x = 0; $x < $Number_rows; $x++) {
    ...
    ?>
          ...
          <br/>
          <!-- Buttons -->
          <button type="submit" class="btn" onclick="window.location.href = 'readyHome.html';" style="margin-left: 200px;margin-top:-30px;margin-bottom: 100px; background-color:#4d77d0; color: white" >Go</button>
                    </form>
