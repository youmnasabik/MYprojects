<?php
    ...
    if(mysqli_connect_errno()){
     ...
     {  
        ...
        $query = "insert into user values ('$FirstName','$LastName','$Email','$Username','$password','$Budget','$Telephone') ";
      ...
      if(mysqli_query($conn, $query))
        {
          ...
          // header("RU-homepage.php\fname?=$_POST['firstname']\lname?=$_POST['lastname']");
        }
        else {
            ...
            <div class="container">
                ...
                <br/><br/><br/>
                    <form role="form">
                        ...
                        <!-- Buttons -->
                        <input name="SubmitButton" type="submit" class="btn" onclick="window.location.href = 'branch.html';" style="margin-left: 14.9pc; background-color:#4d77d0; color: white" >Create>
                    </form>
