...
<?php
$query5="select * from invoice where buyerName='$user'"; //hardcoded now
 ...
 <?php foreach ($row as $rows): ?>
              ...
              <div class="card text-center" >
                  <div class="card-block">
                      ...
                      <p class="card-text" style="background-color:white;"> <a href = "https://www.w3schools.com">Invoice No :<?php echo  $rows['InvoiceNo'] ; ?></a>
                        <br>
                          <br/>
                          <br> <a href = "https://www.w3schools.com">Property No  :<?php echo  $rows['propertyNo'] ; ?></a>
                          <br/>
                          <br/>
                          <br> <a href = "https://www.w3schools.com">Seller is :<?php echo  $rows['SellerName'] ; ?></a>
                          <br/>
                          <br/>
                          <br> <a href = "https://www.w3schools.com"> <?php echo  $rows['datePurchase'] ; ?></a>
                          <br/>
                          <br/>
