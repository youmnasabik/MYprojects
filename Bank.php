        ...
        <div class="container-fluid" style="background-color: #333333; background-image: url(Appartment3.jpg); background-repeat: no-repeat; background-size: 1700px;">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <br />
                        <br />
                        <p class="headings" style="color: white; font-size:40px; margin-left: 55px;">Bank Account</p>
                        <br />
                        <br />
                    </div> 
                </div>
                <div class="row">
                    ...
                    <div class="col">
                        <form action="Bank.php" method="post">
                            ...
                            <input name="Go" type="submit" value="Go" class="btn"  onclick="window.location.href = 'branch.php';" style="font-size:20px; margin-left:65px;color: white; background-color: #4d77d0;"/>
...
$query="insert into invoice(datePurchase, buyerName, SellerName, propertyNo) values ('24-4-2020','$user','$PropId') ";
